...
class SubActivtiy : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvMessage.setTextColor(Color.parseColor("#FA3C3C"))
        tvMessage.textSize = 30.0f
        ...
        tvMessage2.setTextColor(Color.parseColor("#FA3C3C"))
        tvMessage2.textSize = 30.0f

        val btnClick = Button(this)
        btnClick.text = "클릭해주세요"
        btnClick.setOnClickListener {
            Toast.makeText(applicationContext, "조광은님 반갑습니다", Toast.LENGTH_SHORT).show()
            if(flag == true){
        ...
        val liLayout = LinearLayout(this).apply {
            ...
            setBackgroundColor(Color.parseColor("#6E6767"))
